...
const Table = () => {
    ...
    const fetchLeaves = async () => {
        try {
            const response = await axios.get("https://employee-api-lime.vercel.app/api/leave", {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`,
                },
            });
                    ...
                    <div className="p-6" >
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className="space-x-3">
                                <button className="px-6 rounded-md py-2 bg-teal-600 text-white hover:bg-teal-700"
